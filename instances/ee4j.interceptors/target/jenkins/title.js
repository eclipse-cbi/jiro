document.title = "Jakarta Interceptors - " + document.title;
document.addEventListener('DOMContentLoaded', function() {
    let header = document.querySelector('.page-header__brand');
    if (header) {
        let newLink = document.createElement('a');
        newLink.href = 'https://github.com/eclipse-cbi/jiro/blob/master/instances/ee4j.interceptors/target/config.json';
